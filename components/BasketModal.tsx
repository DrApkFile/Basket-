        ...
        {step === "form" && (
          <>
            ...
            <div className="mt-5 grid gap-4">
              <label className="block">
                <span className="text-xs text-white/60">
                  Asset {marketCount > 0 && <span className="text-red-400">({marketCount} markets)</span>}
                </span>
                <select
                  value={asset}
            ...
            <button
              ...
              disabled={!address}
              className="mt-6 w-full rounded-lg bg-red-600 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-red-700 disabled:opacity-50"
            >
          ...
          <>
            ...
            <div className="mt-4 grid grid-cols-3 gap-4 rounded-lg bg-white/5 p-4 text-center text-sm">
              <div>
                ...
                <div className="font-mono text-red-400">${proposal.totalCost.toFixed(2)}</div>
              </div>
              <div>
                <div className="text-xs text-white/40">Worst</div>
                <div className="font-mono text-red-400/60">${proposal.worstCase.toFixed(2)}</div>
              </div>
              <div>
